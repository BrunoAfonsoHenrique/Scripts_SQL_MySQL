...
-- ALTER
ALTER TABLE tb_funcionarios ADD data_termino DATE NULL; -- Adciona coluna

ALTER TABLE tb_produtos DROP COLUMN preco; -- Apaga coluna

ALTER TABLE tb_funcionarios MODIFY COLUMN email varchar(100); -- Modifica coluna
